            ...
            <div class="box-body">
                ...
                <table class="table table-striped table-bordered table-hover">
                    <tbody><tr><th>Файлро интихоб кунед:</th><td>
                            <?= $form->field($model, 'file')->fileInput()->label(false)?></td></tr>
                    <tr><th>Номи хабарро нависед:</th><td>
                            <?=$form->field($model, 'name')->textInput(['autofocus' => true, 'class'=>'form-control','placeholder'=>'Номи файл'])->label(false);?>
                            <div id="errormsg" style="color:red;"></div></td>
                    </tr>
                    <tr><th>Маводи заруриро ворид кунед:</th>
                        <td>
                            <?= $form->field($model, 'text')->textarea(['autofocus' => true, 'class'=>'form-control','placeholder'=>'Шарҳи файл'])->label(false); ?>
                        </td></tr>
                    <tr><th>Барои:</th>
                        <td>
