...
echo Html::submitButton('Сабт намудан',['class'=>'btn btn-primary','name'=>'save','style'=>'padding-left: 10px','onclick'=>'return check()']);
                        ...
                        <th nowrap='' rowspan='2' style='padding-top: 40px; width:282px;'><p align='center'>Ному насаби донишҷӯ</p></th>";
                                ...
                                foreach ($lesson_day as $day) {
                                   ...
                                   elseif($day['type'] <> 'дарсӣ' && $day['type'] =='истироҳат'){
                                        if ($r <= $lesson_count[0]['count']) {
                                            ...
                                            $r++;
                                            // if ($r==($lesson_count['0']['count']/2)+1){
                                            
                                            // echo "<th nowrap=''>Рӯзи Ҷамбасти рейтинги №1<br><span style='color: red'>";
                                            // echo "<th nowrap=''>Рӯзи Ҷамбасти рейтинги №2<br><span style='color: red'>";
                                ...
                                foreach ($lesson_day as $day) {
                                  ...
                                  /*  if ($day['type'] === 'дарсӣ') {
                                        if ($r <= $lesson_count[0]['count']) {
                                            ...
                                            echo "<th><p align='center'>Лексия</p></th><th>";
                                    ...
                                    elseif($day['type'] <> 'дарсӣ' && $day['type'] <> 'истироҳат'){
                                        if ($r <= $lesson_count[0]['count']) {
                                            echo "<th style='color: white; background-color: red'>Лексия</th>";
                                            if (!($r % (8 * $lesson_count[0]['count_time'])))
                                             echo "<th style='color: white; background-color: red'>КМД</th>";
                                            $r++;
                                        }
                                    }
                                }
...
//                                            if (!($q % (3 * $lesson_count[0]['count_time']))) echo "<td nowrap=''>Тасдиқ</td>";
                                    ...
                                    elseif($day['type'] <> 'дарсӣ' && $day['type'] <> 'истироҳат'){
                                        ...
                                        if ($q <= $lesson_count[0]['count']) {
                                            echo "<th style='color: white; background-color: red'></th>";
                                            if (!($q % (8 * $lesson_count[0]['count_time']))) echo "<th style='color: white; background-color: red'></th>";
                                            $q++;
                                        }
                                    }
                                    else {
            ...
            <div class="box-footer">
                <table border="1" style="border-collapse:collapse;border-color:#FF0066;">
                    ...
                    <tr><td>Баҳо</td><td><center><b>Аз 0 то 20</b></center></td></tr>
