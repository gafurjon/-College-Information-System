                        ...
                        <div class='box-body'>
                            ...
                            if(isset($id_group)) {
                                ...
                                if($lessons>0){
                                    ...
                                    echo "<tr>";
                                    echo "<th nowrap='' rowspan='2'>№</th>";
                                    echo "<th nowrap='' rowspan='2'>Гурӯҳ</th>";
                                    foreach($lessons as $lesson){
                                        echo "<th nowrap='' colspan='3'>".$lesson['name']."</th>";
                                    }
                                    echo "</tr>";
                                    ...
                                    foreach ($groups as $group) {
                                        echo "<tr><td>".$r."</td><td><a href='index.php?r=teacher/default/rating&id_group=".$group['id_group']. "'>" .$group['profession']. "</a></td>";
                                        foreach($lessons as $lesson){
                                            for($i=1;$i<=3;$i++) {
                                                echo "<td style='text-align: center";
                                                if($i==3)echo "; background-color: #FFD7FF";
                                                echo "'>";
                                                if ($rating[$group['id_group']][$lesson['id_lesson']][$i]['rating'] <> '') {
                                                    echo round($rating[$group['id_group']][$lesson['id_lesson']][$i]['rating'], 2);
                                                } else {
                                                    echo "-";
                                                }
