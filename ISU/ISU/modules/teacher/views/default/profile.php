...
?>    <!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?=\yii\helpers\Url::to('@web/index.php?r=teacher/default/index')?>"><i class="fa fa-dashboard"></i> Саҳифаи асосӣ</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <?= $form->field($model, 'name')->passwordInput(['placeholder' => 'Пароли ҳозира','name'=>'old_password'])->label(false) ?>
                                </div>
