...
use Yii;
use app\modules\bakaydgiri\models\Persons;
...
/**
 * RegisterController implements the CRUD actions for Persons model.
 */
class RegisterController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->id_persons]);
        } else {
