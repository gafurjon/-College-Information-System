...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; <?= Yii::$app->charset ?>">
     ...
     <title>Системаи иттилооти идоракуни Коллеҷи технологии шаҳри Конибодом</title>
        ...
        <div class="navbar-header pull-left">
            ...
            <a href="<?php echo Yii::getAlias('@web').'/index.php?r=admin/admin/index'; ?>" class="navbar-brand">
                <small>
                    ...
                    Системаи Иттилоотии Идоракунии </b> Коллеҷи технологӣ ба номи А.Қаҳҳорови ш.Конибодом
                </small>
            </a>
        </div>
...
<div class="main-container" id="main-container">
    ...
    <div id="sidebar" class="sidebar responsive">
        ...
        <?php $count_persons=Persons::getOnline(); ?>
        ...
        <ul class="nav nav-list">
            ...
            <p align='center'><font size="2"><b>Ҳоло аз сомона истифода мебаранд:  <? echo $count_persons['0']['online'];?></b>
            </font></p>
        </ul><!-- /.nav-list -->
    ...
    <div class="footer-inner">
        <div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">© 2018 СИИ Коллеҷи омӯзгорӣ ба номи М.Турсунзода шаҳри Конибодом, 
