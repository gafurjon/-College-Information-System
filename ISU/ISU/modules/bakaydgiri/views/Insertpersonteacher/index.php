    ...
    <div class="row">
        <div class="col-xs-8">
            <div class="box-body">
                ...
                <?} 
                elseif(isset($save) and $save=0){?>

                    <div class="alert alert-danger">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                        <h4><i class="icon fa fa-info"></i>Огоҳӣ</h4>
                        Маълумотҳои зарури ворид карда нашуд!
                    </div>
                ...
                <div class="box-header">
                    <h3 class="box-title">Иловаи омӯзгори нав</h3>
                </div>
                ...
                <tr>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <label for="exampleInputFile">Расми омӯзгорро интихоб намоед</label>
                        ...
                        <!-- <div class="form-group">
                            <label>Суроға</label>
                            <input style='width:270px' type="text" name='adress' class="form-control" placeholder="Суроға...">
                        </div> -->
                        ...
                        <!-- Ихтисос -->
                        <div class="form-group">
                            <label>Маълумот:</label><br>

                            <select name="unvon">
                                <option selected="selected" value="0">----</option>
                                <option value="Олӣ">Олӣ</option>
                                <option value="Олӣ нопурра">Олӣ нопурра</option>
                                <option value="Миёна">Миёна</option>
                                <option value="Миёнаи касбӣ">Миёнаи касбӣ</option>
                            </select>
                        </div>
...
<script type="text/javascript">
    ...
    var grid_data =
        [
            ...
            {id:"<?=$row['id_teacher'];?>",
                fio_surname:"<?=$row['person']['surname']?>",
                fio_name:"<?=$row['person']['name']?>",
                fio_middlename:"<?=$row['person']['middle_name']?>",
                work:"<?=$row['work'];?>",
                daraja:"<?=$row['unvon'];?>",
                adres:"<?=$row['person']['adress'];?>",
                telefon:"<?=$row['person']['telefon'];?>"//,
    ...
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            mtype: 'POST',
            height: 350,
            colNames:['', 'ID','Насаб', 'Ном', 'Номи падар','Вазифа', 'Маълумот','Суроға','Телефон',/*'Вазифадиҳӣ','Расм'*/],
            colModel:[
                ...
                {name:'daraja',index:'daraja', width:150, editable: true,edittype:"select",editoptions:{value:"Оли:Оли;Миёна:Миёна"}},
            ...
            editurl: "<?=\yii\helpers\Url::to('@web/index.php?r=bakaydgiri/insertpersonteacher/teachers')?>",//nothing is saved
