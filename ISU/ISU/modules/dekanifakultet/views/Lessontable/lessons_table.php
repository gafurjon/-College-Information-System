            ...
            <div class="grid_st clearfix">
                <div class="">
                    <div class="form_box edit_ctt_wrap">
                        ...
                        <script type="text/javascript" src="/web/admin/timetable_files/dekanifakultet.js"></script>
                        <form action="<?php \yii\helpers\Url::to('@web/site/index.php?r=dekanifakultet/control/select-group-lesson')?>" method="post">
