                            ...
                            <div class="col-md-12" id="content">
                                <blockquote class="col-md-3 pull-right" >
                                    <p style='text-align: justify;'>Ба номи директори
                                       Коллеҷи омӯзгории ба номи М.Турсунзода</p><b class='center text-align: center;'>Ном ва насаб</b>
                                    <br>
                                ...
                                <div class='col-md-12' style='font-size: 20px'>
                                    <?  echo \yii\helpers\Html::beginForm('@web/index.php?r=director/ariza/save'); ?>
