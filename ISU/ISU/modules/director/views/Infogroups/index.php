...
<section class="page-content">
        ...
        if(count($data) > 0) {
            ...
            <h3 class="col-xs-4">
                ...
                $params = [
                    ...
                    'onchange'=>'$.get("index.php?r=director/control/select-group-students&id="+$(this).val(), function(data){$("#content").html(data);})'
    ...
    <script src="/web/admin/jquery-ui.min.js"></script>
