                        ...
                        <tr align='center'>
                          ...
                          <td><?php echo $date?></td>
                            ...
                            <form action="" method="POST">
                                <td>
                                    <a href="<?php echo \yii\helpers\Url::to(['/director/register','id'=> $id_teacher, 'time_in'=>$time, 'oper' => 'in'])?>" >
                                        <input  type="button" name="daromad" class="btn btn-xs btn-success " value="Бақайдгирӣ" /></a></td>
                                <td>
                                    <a href="<?php echo  \yii\helpers\Url::to(['/director/register','id'=> $id_teacher, 'time_out'=>$time, 'oper' => 'out'])?>" >
