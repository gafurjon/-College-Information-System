            ...
            <div class="grid_st clearfix">
                <div class="">
                    <div class="form_box edit_ctt_wrap">
                        ...
                        <script type="text/javascript" src="/ktk.tj/web/admin/timetable_files/e5039b7465f6.js"></script>
                        <form action="<?php \yii\helpers\Url::to('@web/site/index.php?r=admin/admin/select-group-lesson')?>" method="post">
