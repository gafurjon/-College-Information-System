...
<script type="text/javascript">
    ...
    var grid_data =
        [
            ...
            {id:"<?=$row['id_teacher'];?>",
                fio_surname:"<?=$row['id_teacher'].$row['person']['0']['surname']?>",
    ...
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            mtype: 'POST',
            height: 350,
            colNames:['', 'ID','Насаб', 'Ном', 'Номи падар','Ихтисос', 'Дараҷа','Суроға','Телефон','Вазифадиҳӣ'/*,'Расм'*/],
            colModel:[
                ...
                {name:'fio_surname',index:'fio_surname', width:300, editable: true,editoptions:{size:"20",maxlength:"30"}},
                {name:'fio_name',index:'fio_name', width:300, editable: true,editoptions:{size:"20",maxlength:"30"}},
                {name:'fio_middlename',index:'fio_middlename', width:300, editable: true,editoptions:{size:"20",maxlength:"30"}},
                {name:'work',index:'work', width:250,editable: true,editoptions:{size:"20",maxlength:"255"}},
            ...
            editurl: "<?=\yii\helpers\Url::to('@web/index.php?r=admin/control/teachers')?>",//nothing is saved
