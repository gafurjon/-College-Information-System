        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                    <? echo Html::beginForm('@web/index.php?r=admin/ariza/insert_ariza');?>
                        ...
                        foreach ($arizaho as $item) {
                          ...
                          $fio=$item['teacher']['person']['0']['surname'].' '.$item['teacher']['person']['0']['name'].' '.
                            ...
                            <tr align='center'>
                                ...
                                <td align='left'><a href="<?= \yii\helpers\Url::to('/web/index.php?r=admin/ariza/select_ariza&id=').$item['id_ariza']?>"><?php echo $fio;?></a> </td>
